...
vim.api.nvim_set_keymap('i', '<c-f>', "vim.fn['compe#complete']()", { expr = true, noremap = true, silent = true })
vim.api.nvim_set_keymap('i', '<c-d>', "vim.fn['compe#complete']()", { expr = true, noremap = true, silent = true })
